    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Explore Murad Mursela's architectural and interior design projects, including modern apartments, corporate banks, hospitals, resorts, studios, and cultural spaces, blending creativity with functional design.",
      },
    ],
  },
};
