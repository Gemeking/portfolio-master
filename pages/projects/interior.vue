    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Explore Murad Mursela's recent interior design projects, showcasing modern aesthetics, functional spaces, and innovative kitchen designs with stunning visuals.",
      },
    ],
  },
};
