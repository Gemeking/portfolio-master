  ...
  <div class="projects-page container animate__animated animate__fadeIn">
    ...
    >
      ...
      <div class="col-md-6 project-details">
        ...
        <p class="category text-muted">{{ project.category }}</p>
        <hr class="highlight" />
...
export default {
    ...
    return {
      ...
      projects: [
        ...
        },
        {
          ...
          description:
            "A selection of 5 unique T-shirt design concepts emphasizing modern vector art and cultural expression.",
  ...
  head: {
    title: "Projects - Murad Mursela",
    meta: [
      {
        hid: "description",
        name: "description",
        content:
          "Explore Murad Mursela's creative projects in logo design, promotional materials, AI-generated visuals, posters, apparel graphics, and YouTube thumbnails, showcasing innovative design and storytelling.",
      },
    ],
  },
};
